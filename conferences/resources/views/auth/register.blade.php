                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select" name="type_id" value="{{ old('last_name') }}" required>
                                    @foreach($types as $type)
                                        <option {{$type->id == old('type_id') ? ' selected ' : ''}} value="{{$type->id}}">{{$type->name}}</option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select class="form-select" name="country_id" value="{{ old('country_id') }}" required>
